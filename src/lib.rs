...
#[derive(Debug)]
pub struct GraphPlotProcessor {
    verbose: bool,
    processed_count: usize,
}

impl GraphPlotProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting GraphPlot processing");
    
    let mut processor = GraphPlotProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = GraphPlotProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = GraphPlotProcessor::new(false);
